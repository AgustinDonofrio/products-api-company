...
var singIn = exports.singIn = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body2, password, email, userFound, matchPassword, token;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$body2 = req.body, password = _req$body2.password, email = _req$body2.email;
          _context2.next = 4;
        ...
        case 7:
          _context2.next = 9;
          return _User["default"].comparePassword(password, userFound.pasword);
        case 9:
